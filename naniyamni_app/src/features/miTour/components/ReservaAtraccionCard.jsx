      ...
      <div className="p-6 md:p-8 flex-1">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-2 mb-4">
          ...
          <div className="flex items-start">
            ...
            <a onClick={() => irAProveedor(servicio.proveedor)} className="dark:text-[#F9FAFB]/90 text-sm text-gray-800 dark:hover:text-gray-400 underline hover:text-gray-700 cursor-pointer text-nowrap overflow-ellipsis">{proveedor_nombre}</a>
          </div>
        </div>
